      seqfile = case_b.phy            * Path to the alignment file
     treefile = case_b.tree           * Path to the tree file
      outfile = out_caseB_M0.txt      * Path to the output file
   
        noisy = 3                     * How much rubbish on the screen
      verbose = 1                     * More or less detailed report

      seqtype = 1                     * Data type
        ndata = 3 separate_trees      * Number of data sets or loci
