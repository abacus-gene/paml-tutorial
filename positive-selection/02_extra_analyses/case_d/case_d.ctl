      seqfile = case_d.phy            * Path to the alignment file
     treefile = case_d.tree           * Path to the tree file
      outfile = out_caseD_M0.txt      * Path to the output file
   
        noisy = 3                     * How much rubbish on the screen
      verbose = 1                     * More or less detailed report

      seqtype = 1                     * Data type
        ndata = 3 maintree 0          * Number of data sets or loci
